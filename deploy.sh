...
sudo docker run -d --network gem --name postgres --restart unless-stopped -p 5432:5432 -v ./infra/data/postgres:/var/lib/postgresql/data -e POSTGRES_PASSWORD=geDteDd0Ltg2135FJYQ6rjNYHYkGQa70 -e POSTGRES_USER=root -e PGDATA=/var/lib/postgresql/data/pgdata postgres
