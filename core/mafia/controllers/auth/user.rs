...
pub async fn edit_profile(req: Request<Body>) -> MafiaResult<hyper::Response<Body>, hyper::Error>{
...
pub async fn get_all(req: Request<Body>) -> MafiaResult<hyper::Response<Body>, hyper::Error>{
