...
pub static TASK_NOT_VERIFIED: &str = "Task Couldn't Be Verified Successfully (Twitter Couldn't Verified The Task), Deleted Relevant User Task";
...
pub static USER_TASK_HAS_ALREADY_BEEN_DELETED: &str = "The User Task Has Already Been Deleted";
