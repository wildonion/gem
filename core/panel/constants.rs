...
pub static ID_BUILT: &str = "New Crypto Id Built Successfully, Remember To Save Your `singer` Field Value";
...
pub static RECIPIENT_NOT_FOUND: &str = "No Recipient Found With This Screen Crypto Id";
