...
pub static NOT_VERIFIED_PHONE: &str = "Phone Is Not Verified";
pub static PHONE_VERIFICATION_CODE_SENT: &str = "Phone Verification Code Has Benn Sent Successfully";
pub static EXPIRED_PHONE_CODE: &str = "Phone Code Has Been Expired";
pub static INVALID_PHONE: &str = "Phone Is Invalid For This User";
pub static INVALID_PHONE_CODE: &str = "Invalid Phone Code";
pub static PHONE_VERIFIED: &str = "User Phone Has Been Verified Successfully";
pub static NO_PHONE_FOR_THIS_USER: &str = "There Is No Verification Process For This Phone";
