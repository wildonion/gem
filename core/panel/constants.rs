...
pub static CANT_MINT_CARD: &str = "Contract Didn't Mint The Card, Contact Administrator To Get Back Your Funds";
pub static CANT_BURN_CARD: &str = "Contract Didn't Burn The Card, Try Again Later";
