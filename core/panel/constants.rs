...
pub static CANT_UPDATE_COLLECTION_ONCHAIN: &str = "Can't Update Collection Contract Address At The Moment, We're Getting Blockchain Confirmation, Try Later";
...
pub static CALLER_IS_CANT_VIEW_GALLERY: &str = "Gallery Is Not Viewable For The Caller Of This Method";
