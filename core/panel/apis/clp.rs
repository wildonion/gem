            ...
            match req.get_user(granted_role, connection).await{
                Ok(token_data) => {
                    ...
                    */
                    ...
                    // if anything went well we should update the joined_at field, user just joined successfully
