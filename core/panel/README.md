...
* chatroom launchpad endpoint is `wss://notif.panel.conse.app/subscribe/chatroomlp/{chatroomlp_id}/{user_screen_cid}/{tx_signature}/{hash_data}/?r1pubkey={r1pubkey}&r1signature={r1signature}` and there must be JWT in header like: `Authorization`: `Bearer ...JWT...`.