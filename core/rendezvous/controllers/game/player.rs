...
pub async fn update_role(req: Request<Body>) -> RendezvousResult<hyper::Response<Body>, hyper::Error>{
...
pub async fn update_side(req: Request<Body>) -> RendezvousResult<hyper::Response<Body>, hyper::Error>{
...
pub async fn update_status(req: Request<Body>) -> RendezvousResult<hyper::Response<Body>, hyper::Error>{
...
pub async fn update_role_ability(req: Request<Body>) -> RendezvousResult<hyper::Response<Body>, hyper::Error>{
...
pub async fn cast_vote_on_player(req: Request<Body>) -> RendezvousResult<hyper::Response<Body>, hyper::Error>{
                                            ...
                                            if event_doc.group_info.unwrap().god_id.unwrap() == god_id.to_string(){ // the caller of this api must be the god of the passed in event_id to vote on a specific player
                                                ...
                                                if player_inside_this_event{
                                                    match god_votes_on_players.find_one(doc!{"user_id": vote_info.user_id, "event_id": vote_info.event_id}, None).await.unwrap(){
                                                        Some(vote_doc) => {
                                                            let response_body = misc::app::Response::<schemas::game::GodVotesOnPlayerInfo>{
                                                                data: Some(vote_doc),
...
pub async fn chain_to_another_player(req: Request<Body>) -> RendezvousResult<hyper::Response<Body>, hyper::Error>{
...
pub async fn get_single(req: Request<Body>) -> RendezvousResult<hyper::Response<Body>, hyper::Error>{ // this api will return the current status and infos of a player during the game and can be called by the God and the player
...
pub async fn get_single_god_vote(req: Request<Body>) -> RendezvousResult<hyper::Response<Body>, hyper::Error>{ // this api will return the current status and infos of a player during the game and can be called by the God and the player
...
// ➝ Return : Hyper Response Body or Hyper Error
// -------------------------------------------------------------------------
pub async fn get_all_god_votes(req: Request<Body>) -> RendezvousResult<hyper::Response<Body>, hyper::Error>{
                                ...
                                Ok(user_info) => { // we got the username and password inside the login route
                                    ...
                                    match god_votes_on_players.find(filter, None).await{
                                        Ok(mut cursor) => {
                                            ...
                                            let res = Response::builder(); // creating a new response cause we didn't find any available route
                                            let response_body = misc::app::Response::<Vec<schemas::game::GodVotesOnPlayerInfo>>{ // the return type is a vector of all god vote infos related to passed in player id
                                                message: FETCHED,
                                                data: Some(votes),
                                                status: 200,
                                            };
...
pub async fn get_player_role_ability(req: Request<Body>) -> RendezvousResult<hyper::Response<Body>, hyper::Error>{ // this api will return the current role ability of a specific player during the game and can be called by the God and the player
...
pub async fn get_player_chain_infos(req: Request<Body>) -> RendezvousResult<hyper::Response<Body>, hyper::Error>{ // this api will return the current chain infos of a specific player during the game and can be called by the God and the player
                                ...
                                Ok(player_info) => { // we got the username and password inside the login route
                                    ...
                                    match player_chain_info.find(filter, None).await{
                                        Ok(mut cursor) => {
                                            ...
                                            let response_body = misc::app::Response::<schemas::game::AvailableChainInfos>{
                                                message: FETCHED,
