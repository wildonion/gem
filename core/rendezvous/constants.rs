...
pub type RendezvousResult<T, E> = std::result::Result<T, E>;
pub static mut DB: Option<Arc<misc::app::Storage>> = None; // NOTE - use of mutable static is unsafe and requires unsafe function or block since mutable statics can be mutated by multiple threads: aliasing violations or data races will cause undefined behavior
...
pub static HTTP_HEADER_ERR: &str = "Can't Read Header Value";
