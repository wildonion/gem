...
Conse is a crypto based friendly gathering **Game Event Manager**, advertising platform, gallery based NFT Marketplace on top of **Polygon** and **Patel Sense APIs** uses the following engines: 
